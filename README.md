...
3. ㄑ改為cy（自創，通拼+耶魯）、ㄒ改為shy（耶魯）、ㄘ改為ts（國羅）   
4. ㄩ改為yu（漢拼草案），ㄠ恢復為au（國羅），ㄝ改為eh（WG），空韻使用ih（國羅）    
5. 增加ㄅㄆㄇㄈ+ㄛ時補ㄨ的規則，以符合台灣人實際發音習慣。 
6. 結合韻母採注音二式方案，即ㄩㄣ和ㄩㄥ中的ㄩ以ㄧ+ㄨ合成的iu表示   
...
ＰＨ：Cyu Kuai Lian Jih Shu De Ying Yung Yu Wei Lai  
